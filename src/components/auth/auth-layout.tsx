...
export default function AuthLayout({ children, onClose, view }: ExtendedAuthLayoutProps) {
    return (
        <div
            className="fixed inset-0 z-[2000] flex items-end sm:items-center justify-center p-0 sm:p-4 overflow-x-hidden overflow-y-auto scrollbar-hide"
            style={{
        ...
        >
            <div
                className="relative w-full sm:max-w-md max-h-[96dvh] overflow-x-hidden overflow-y-auto scrollbar-hide animate-modal-in bg-white rounded-t-[20px] sm:rounded-[20px]"
                style={{
